...
public class _4 implements Serializable {
    ...
    //private final static long serialVersionUID = 4796093055861151579L;
    @SerializedName("abr")
    @Expose
    private String abr;
    @SerializedName("id")
     ...
     * @param day3Value
     */
    public _4(String abr, String id, String day1Value, String day1Percent, String day2Value, String day2Percent, String day3Value, String day3Percent, String day4Value, String day4Percent, String day5Value, String day5Percent) {
        super();
        this.abr = abr;
        this.id = id;
