...
public class Meser implements Serializable {

    private final static long serialVersionUID = 73931589941683017L;
    @SerializedName("id")
    @Expose
    private String id;
     ...
     * @param doseId
     */
    public Meser(String id, String measurementId, String trainingExerciseId, String measurementName, String doseId, List<MeasurementValue> measurementValue) {
        super();
        this.id = id;
