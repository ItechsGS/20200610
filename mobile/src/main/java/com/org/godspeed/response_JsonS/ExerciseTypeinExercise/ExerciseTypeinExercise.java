...
public class ExerciseTypeinExercise implements Serializable {
    ...
    public ExerciseTypeinExercise(String exerciseSetsId, String exerciseId, String setName, String tempo, String weight, String reps, String gymAccountId, String lastModifyTime) {
        super();
