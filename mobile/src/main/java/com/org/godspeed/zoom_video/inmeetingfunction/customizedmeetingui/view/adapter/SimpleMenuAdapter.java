package com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.adapter;
...
public class SimpleMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtLabel = convertView.findViewById(us.zoom.androidlib.R.id.txtLabel);
