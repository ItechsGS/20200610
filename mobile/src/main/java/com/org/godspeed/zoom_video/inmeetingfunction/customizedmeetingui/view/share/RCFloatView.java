...
public class RCFloatView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mIvRCControl = view.findViewById(R.id.rc_control);
        mIvKeyboard = view.findViewById(R.id.rc_keyboard);
        mIvQuestion = view.findViewById(R.id.rc_question);
        mVGContentSpan = view.findViewById(R.id.rc_content_span);
        mHiddenEditText = view.findViewById(R.id.rc_hidden_edit);
        mVGFloatPanel = view.findViewById(R.id.rc_float_panel);
