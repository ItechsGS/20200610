...
public class InitAuthSDKActivity extends Activity implements InitAuthSDKCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSSOLogin = findViewById(R.id.btnSSOLogin);
        mBtnSSOLogin.setOnClickListener(this);

        mBtnWithoutLogin = findViewById(R.id.btnWithoutLogin);
        ...
        mProgressPanel.setVisibility(GONE);

        InitAuthSDKHelper.getInstance().initSDK(this, this);

        if (mZoomSDK.isInitialized()) {
            mBtnEmailLogin.setVisibility(VISIBLE);
            mBtnSSOLogin.setVisibility(VISIBLE);
            mBtnWithoutLogin.setVisibility(VISIBLE);
            layoutJoin.setVisibility(VISIBLE);
            ...
            mBtnEmailLogin.setVisibility(GONE);
            mBtnSSOLogin.setVisibility(GONE);
            mBtnWithoutLogin.setVisibility(GONE);
            layoutJoin.setVisibility(GONE);
        }
    }
...
//        } else {
    ...
    private void showProgressPanel(boolean show) {
        if (show) {
            ...
            mBtnSSOLogin.setVisibility(GONE);
            mBtnWithoutLogin.setVisibility(GONE);
            mProgressPanel.setVisibility(VISIBLE);
            layoutJoin.setVisibility(GONE);
            View view = findViewById(R.id.btnSettings);
            if (null != view) {
