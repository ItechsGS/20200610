package com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.share;
...
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.AndroidAppUtil;
...
public class AnnotateToolbar extends FrameLayout implements IColorChangedListener, View.OnClickListener {
    ...
    private void initAnnotateView(Context context) {
        mAnnotateBtn = mView.findViewById(R.id.btnAnnotate);
        ...
        mCloseBtn = mView.findViewById(R.id.shareEditBtn);
        ...
        mSpotlight = mView.findViewById(R.id.btnSpotlight);
        mHighlight = mView.findViewById(R.id.btnHighlight);
        mPen = mView.findViewById(R.id.btnPen);
        mErase = mView.findViewById(R.id.btnErase);
        mColorIndicator = mView.findViewById(R.id.btnColorIndicator);

        mColorImage = mColorIndicator.findViewById(R.id.colorImage);
        mArrow = mView.findViewById(R.id.btnArrow);
        mClear = mView.findViewById(R.id.btnClear);
        ...
        mColorTable = contentView.findViewById(R.id.colorTable);
        txtLineWidth = contentView.findViewById(R.id.txtLineWidth);
        ...
        mLineWidthSeekBar = contentView.findViewById(R.id.seekbar);
