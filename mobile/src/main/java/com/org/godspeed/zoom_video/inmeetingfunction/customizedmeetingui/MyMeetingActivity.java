...
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.audio.MeetingAudioCallback;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.audio.MeetingAudioHelper;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.other.MeetingCommonCallback;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.share.MeetingShareCallback;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.share.MeetingShareHelper;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.user.MeetingUserCallback;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.video.MeetingVideoCallback;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.video.MeetingVideoHelper;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.MeetingOptionBar;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.MeetingWindowHelper;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.RealNameAuthDialog;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.share.AnnotateToolbar;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.share.CustomShareView;
import com.org.godspeed.zoom_video.ui.APIUserStartJoinMeetingActivity;
import com.org.godspeed.zoom_video.ui.BreakoutRoomsAdminActivity;
import com.org.godspeed.zoom_video.ui.InitAuthSDKActivity;
...
public class MyMeetingActivity extends ZMActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
        ...
        MeetingUserCallback.UserEvent, MeetingCommonCallback.CommonEvent, SmsListener, GodSpeedInterface {
    ...
    MeetingVideoHelper.VideoCallBack videoCallBack = new MeetingVideoHelper.VideoCallBack() {
        ...
        public boolean requestVideoPermission() {
            ...
            if (Build.VERSION.SDK_INT >= 23 && checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MyMeetingActivity.this, new String[]{Manifest.permission.CAMERA}, REQUEST_CAMERA_CODE);
                return false;
            }
            return true;
        }
        ...
        public void onHasAttendeeRightsNotification(final IBOAttendee iboAttendee) {
            ...
            if (boController.isInBOMeeting()) {
                ...
                ZMAlertDialog.Builder builder = new ZMAlertDialog.Builder(MyMeetingActivity.this)
                        ...
                        .setNegativeButton("Later", (dialog, which) -> mBtnJoinBo.setVisibility(View.VISIBLE))
                        .setPositiveButton("Join", (dialog, which) -> iboAttendee.joinBo())
                        .setCancelable(false);
    ...
    private void refreshToolbar() {
        ...
        if (mInMeetingService.getCurrentMeetingNumber() != 0) {
//            webServices.addLiveClass("8",  format2.format(new Date()).toString()+"",
//                    mInMeetingService.getCurrentMeetingNumber()+"", mInMeetingService.getMeetingPassword()+"",
//                    this, MyMeetingActivity.this);
        }
    ...
    private void showLeaveMeetingDialog() {
        ...
        if (mInMeetingService.isMeetingConnected()) {
            if (mInMeetingService.isMeetingHost()) {
                builder.setTitle("End or leave meeting")
                        .setPositiveButton("End", (dialog, which) -> leave(true));
                //.setNeutralButton("Leave", (dialog, which) -> leave(false));
            } else {
                builder.setTitle("Leave meeting")
                        .setPositiveButton("Leave", (dialog, which) -> leave(false));
            }
        } else {
            builder.setTitle("Leave meeting")
                    .setPositiveButton("Leave", (dialog, which) -> leave(false));
        ...
        if (mInMeetingService.getInMeetingBOController().isInBOMeeting()) {
            builder.setNegativeButton("Leave BO", (dialog, which) -> leaveBo());
        } else {
