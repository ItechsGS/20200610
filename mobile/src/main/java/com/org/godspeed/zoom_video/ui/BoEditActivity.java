...
import com.org.godspeed.zoom_video.ui.dialog.SwitchAssignedUserToRunningBODialog;
...
public class BoEditActivity extends ZMActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEdtxBoName = findViewById(R.id.edtx_bo_name);
        mBtnDeleteBo = findViewById(R.id.btn_delete_bo);
        mBtnSaveBoName = findViewById(R.id.btn_save_bo_name);
        mBoUserLv = findViewById(R.id.lv_bo_users);
    ...
    public static class BoUserListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Button btn_move_to = view.findViewById(R.id.btn_move_to);
