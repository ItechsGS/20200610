package com.org.godspeed.zoom_video.otherfeatures.scheduleforloginuser;
...
public class ScheduleMeetingExampleActivity extends Activity implements PreMeetingServiceListener, OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSchedule = findViewById(R.id.btnSchedule);
        mBtnSchedule.setOnClickListener(this);

        mEdtTopic = findViewById(R.id.edtTopic);
        mEdtPassword = findViewById(R.id.edtPassword);
        mChkEnableJBH = findViewById(R.id.chkEnableJBH);
        mChkHostVideo = findViewById(R.id.chkHostVideo);
        mChkAttendeeVideo = findViewById(R.id.chkAttendeeVideo);

        mChkVoip = findViewById(R.id.chkVoip);
        mChkTelephony = findViewById(R.id.chkTelephony);
        mChk3rdPartyAudio = findViewById(R.id.chk3rdPartyAudio);
        mEdt3rdPartyAudio = findViewById(R.id.edt3rdPartyAudio);

        mOptionTelephony = findViewById(R.id.optionTelephony);
        mOption3rdPartyAudio = findViewById(R.id.option3rdPartyAudio);

        mChkUsePMI = findViewById(R.id.chkUsePMI);
        mChkOnlySignJoin = findViewById(R.id.chkOnlySignCanJoin);
        mOptionOnlySignJoin = findViewById(R.id.optionOnlySignCanJoin);

        mEdtSpecifiedDomains = findViewById(R.id.edtSpecifiedDomains);

        mChkHostInChina = findViewById(R.id.chkHostInChina);
        mOptionHostInChina = findViewById(R.id.optionHostInChina);

        mChkScheduleFor = findViewById(R.id.chkScheduleFor);
        mOptionScheduleFor = findViewById(R.id.optionScheduleFor);
        mSpDwonScheduleFor = findViewById(R.id.spDwonScheduleFor);
        ...
        mChkAutoRecord = findViewById(R.id.chkAutoRecord);
        mChkLocalRecord = findViewById(R.id.chkLocalRecord);
        mChkCloudRecord = findViewById(R.id.chkCloudRecord);
        ...
        mTxtTimeFrom = findViewById(R.id.txtTimeFrom);
        mTxtTimeTo = findViewById(R.id.txtTimeTo);
        mTxtTimeZoneName = findViewById(R.id.txtTimeZone);
