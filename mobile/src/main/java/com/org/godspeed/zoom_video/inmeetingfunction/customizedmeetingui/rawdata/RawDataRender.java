package com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.rawdata;
...
public class RawDataRender extends ZoomTextureViewRender {
    ...
    public MobileRTCRawDataError subscribe(long userId, ZoomSDKRawDataType type) {
        ...
        isSubscribeSuccess = ret == MobileRTCRawDataError.MobileRTCRawData_Success;
        cacheRawDataType = null;
        cacheUserId = -1;
