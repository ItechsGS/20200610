...
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.view.adapter.CameraMenuItem;
    ...
    public void switchCamera() {
        if (mInMeetingVideoController.canSwitchCamera()) {
            ...
            if (devices != null && devices.size() > 1) {
                ...
                ListView cameraList = popupWindowLayout.findViewById(R.id.actionListView);
