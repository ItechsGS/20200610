...
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.rawdata.AudioRawDataUtil;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.rawdata.RawDataRender;
import com.org.godspeed.zoom_video.inmeetingfunction.customizedmeetingui.rawdata.UserVideoAdapter;
...
public class RawDataMeetingActivity extends FragmentActivity implements InMeetingServiceListener, MeetingServiceListener, InMeetingShareController.InMeetingShareListener, View.OnClickListener, UserVideoAdapter.ItemTapListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onMeetingUserJoin: " + ZoomSDK.getInstance().getInMeetingService().getCurrentMeetingID());
        Log.d(TAG, "onMeetingUserJoin: " + ZoomSDK.getInstance().getInMeetingService().getMeetingPassword());
    }
