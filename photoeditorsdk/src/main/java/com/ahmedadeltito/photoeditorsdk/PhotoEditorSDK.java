...
public class PhotoEditorSDK implements MultiTouchListener.OnMultiTouchListener {
    ...
    private RelativeLayout parentView, parent_image_rx;
    ...
    private PhotoEditorSDK(PhotoEditorSDKBuilder photoEditorSDKBuilder) {
        ...
        this.parent_image_rx = photoEditorSDKBuilder.parentView;
    ...
    public void addImage(Bitmap desiredImage) {
        ...
        MultiTouchListener multiTouchListener = new MultiTouchListener(deleteView,
                parentView, this.imageView, onPhotoEditorSDKListener, desiredImage);
    ...
    public void addText(String text, int colorCodeTextView) {
        ...
        MultiTouchListener multiTouchListener = new MultiTouchListener(deleteView,
                parentView, this.imageView, onPhotoEditorSDKListener, null);
        multiTouchListener.setOnMultiTouchListener(this);
        addTextRootView.setOnTouchListener(multiTouchListener);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        if (LastX != 0f && LastY != 0f) {
            addTextRootView.setX(LastX);
            addTextRootView.setY(LastY);
            LastX = 0f;
            LastY = 0f;
        } else {
            params.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
    ...
    public void addTextWithImage(String text, int colorCodeTextView, Bitmap desiredImage) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        addTextRootView = inflater.inflate(R.layout.photo_editor_sdk_add_text_with_image, null);
        TextView addTextView = addTextRootView.findViewById(R.id.photo_editor_sdk_text_tv);
        ImageView addImageView = addTextRootView.findViewById(R.id.photo_editor_sdk_text_image);
        Drawable d = new BitmapDrawable(desiredImage);
        addImageView.setImageDrawable(d);
        addTextView.setGravity(Gravity.CENTER);
        addTextView.setText(text);
        if (colorCodeTextView != -1) {
            addTextView.setTextColor(colorCodeTextView);
        }
        MultiTouchListener multiTouchListener = new MultiTouchListener(deleteView, parentView, this.imageView, onPhotoEditorSDKListener, desiredImage);
        multiTouchListener.setOnMultiTouchListener(this);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        addTextRootView.setOnTouchListener(multiTouchListener);
    ...
    public String saveImage() {
        if (isSDCARDMounted()) {
            ...
            if (parentView != null) {
                parentView.setDrawingCacheEnabled(true);
                parentView.getDrawingCache().compress(Bitmap.CompressFormat.JPEG, 90, bytes);
            }
    ...
    public Uri getLocalBitmapUri() {
        ...
        try {
            ...
            if (parentView != null) {
                parentView.setDrawingCacheEnabled(true);
                parentView.getDrawingCache().compress(Bitmap.CompressFormat.JPEG, 90, out);
            }
...
//        Log.e(VolleyLog.TAG, "onEditTextClickListener:text "+text);
...
//    }
    ...
    @Override
    public void onEditTextClickListener(String text, int colorCode, Bitmap bitmap, float x, float y) {
        if (addTextRootView != null) {


            LastX = x;
            LastY = y;
            Log.e(TAG, "onEditTextClickListener: " + LastX + "   " + LastY);
            parentView.removeView(addTextRootView);
            addedViews.remove(addTextRootView);
        }
    }
    ...
    public static class PhotoEditorSDKBuilder {
        ...
        private RelativeLayout parent_image_rx;
        private ImageView imageView;
        private View deleteView;
        private BrushDrawingView brushDrawingView;
        ...
        public PhotoEditorSDKBuilder parentView(RelativeLayout parentView) {
            ...
            this.parent_image_rx = parentView;
            return this;
        }
...
//
//
//    public void addTextWithImage(String text, int colorCodeTextView,
//                                 Bitmap desiredImage) {
//        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        addTextRootView = inflater.inflate(R.layout.photo_editor_sdk_add_text_with_image, null);
//        TextView addTextView = (TextView) addTextRootView.findViewById(R.id.photo_editor_sdk_text_tv);
//        ImageView addImageView = (ImageView) addTextRootView.findViewById(R.id.photo_editor_sdk_text_image);
//        addImageView.setImageBitmap(desiredImage);
//        addTextView.setGravity(Gravity.CENTER);
//        addTextView.setText(text);
//        if (colorCodeTextView != -1) {
//            addTextView.setTextColor(colorCodeTextView);
